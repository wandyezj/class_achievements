...
Students should be able to evaluate the course as well, so that it can be better refined.


# Observations from TEALS volunteers

> Students need to be motivated to achieve objectives. In the case of an assignment where feedback is provided and there is an option to redo the assignment few students in one case decided to redo the assignment for the return in points. Students who were already doing well in class generally didn't need to redo assignments.
